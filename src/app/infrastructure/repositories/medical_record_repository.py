...
from app.application.ports.medical_record_repository import (
    AccessibleMedicalRecord,
...
from app.infrastructure.db.models.medical_record import (
    MedicalRecordRow,
...
from app.infrastructure.db.models.user_record_link import UserRecordLinkRow, UserRecordLinkSourceRow
...
class SqlAlchemyMedicalRecordRepository(MedicalRecordRepositoryPort):
    ...
    def create_record(
        ...
        self._session.refresh(record_row)

        return AccessibleMedicalRecord(
    ...
    def _accessible_record_query(self, record_id: UUID, user_id: UUID) -> Select[tuple[MedicalRecordRow, UUID | None]]:
        ...
        return (
            ...
            .outerjoin(PatientPassportRow, PatientPassportRow.id == UserRecordLinkRow.patient_passport_id)
            .where(MedicalRecordRow.id == record_id, UserRecordLinkRow.user_id == user_id)
